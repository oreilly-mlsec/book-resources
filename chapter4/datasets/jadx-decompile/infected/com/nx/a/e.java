...
public class e extends h {
    ...
    protected void a(boolean z) {
        if (this.n == null) {
            this.n = l.a(this.b, "setIntentRedelivery");
        }
        b.a(this.b, this.n, new Object[]{Boolean.valueOf(z)});
    }
    ...
    protected void d(Intent intent) {
        if (this.m == null) {
            this.m = l.a(this.b, "onHandleIntent");
        }
        b.a(this.b, this.m, new Object[]{intent});
    }
}
