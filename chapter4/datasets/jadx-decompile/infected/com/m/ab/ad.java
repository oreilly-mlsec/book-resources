...
class ad {
    protected static int aa(byte b) {
        return (b + 256) % 256;
    }

    protected static short aa(byte[] bArr, int i) {
        return (short) ((bArr[i + 1] << 8) | (bArr[i + 0] & 255));
    }

    protected static void aa(byte[] bArr, double d, int i) {
    ...
    protected static void aa(byte[] bArr, float f, int i) {
    ...
    protected static void aa(byte[] bArr, int i, int i2) {
        bArr[i2] = (byte) (i & 255);
    ...
    protected static void aa(byte[] bArr, long j, int i) {
    ...
    protected static void aa(byte[] bArr, short s, int i) {
        bArr[i + 1] = (byte) (s >> 8);
        bArr[i + 0] = (byte) (s >> 0);
    }

    protected static int ab(byte[] bArr, int i) {
        return ((((bArr[i + 3] & 255) << 24) | ((bArr[i + 2] & 255) << 16)) | ((bArr[i + 1] & 255) << 8)) | ((bArr[i + 0] & 255) << 0);
    }

    protected static long ac(byte[] bArr, int i) {
    ...
    protected static float ad(byte[] bArr, int i) {
    ...
    protected static double ae(byte[] bArr, int i) {
